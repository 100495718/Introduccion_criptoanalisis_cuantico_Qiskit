...
Este proyecto es una introducción al criptoanálisis cuántico empleando Qiskit, aplicando el agloritmo de Grover sobre instancias pequeñas del problema LWE mediante un oráculo simplificado. Mediante simulaciones, se analizan las iteraciones necesarias para que el algoritmo encuentre la solución con alta probabilidad.
